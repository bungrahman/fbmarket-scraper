...
(async () => {
  ...
  fs.writeFileSync('debug-mercari.html', await page.content());
  await page.screenshot({ path: 'debug-mercari.png' });
  ...
  fs.writeFileSync('mercari.json', JSON.stringify(scrapedData, null, 2));
  console.log(`✅ Dapat ${scrapedData.length} produk dari Mercari.`);
